class HangmanGame {
    constructor() {
        ...
        this.words = {
            easy: [
                'CAT', 'DOG', 'SUN', 'MOON', 'STAR', 'TREE', 'BOOK', 'CAKE',
                'BIRD', 'FISH', 'HAND', 'FOOT', 'EYE', 'NOSE', 'MOUTH', 'HAIR',
                'CAR', 'BUS', 'TRAIN', 'PLANE', 'SHIP', 'BIKE', 'WALK', 'RUN',
                'JUMP', 'PLAY', 'SING', 'DANCE', 'READ', 'WRITE', 'DRAW'
            ],
            medium: [
                'JAVASCRIPT', 'PROGRAMMING', 'COMPUTER', 'ALGORITHM', 'DATABASE',
                'NETWORK', 'SOFTWARE', 'HARDWARE', 'INTERFACE', 'FUNCTION',
                'VARIABLE', 'CONSTANT', 'OBJECT', 'CLASS', 'METHOD',
                'ARRAY', 'STRING', 'NUMBER', 'BOOLEAN', 'NULL', 'UNDEFINED',
                'PROTOTYPE', 'INHERITANCE', 'POLYMORPHISM', 'ENCAPSULATION'
            ],
            hard: [
                'IMPLEMENTATION', 'ARCHITECTURE', 'OPTIMIZATION', 'PERFORMANCE',
                'SCALABILITY', 'MAINTENANCE', 'DOCUMENTATION', 'TESTING',
                'DEPLOYMENT', 'INTEGRATION', 'MICROSERVICES', 'CONTAINERIZATION',
                'VIRTUALIZATION', 'DISTRIBUTED', 'ASYNCHRONOUS', 'CONCURRENT',
                'PARALLELISM', 'MULTITHREADING', 'MEMORY_MANAGEMENT', 'GARBAGE_COLLECTION'
            ]
        };
